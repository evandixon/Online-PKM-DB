...
<div>
    ...
    <dl class="dl-horizontal">
        ...
        @* Was Egg *@
        <dt>
            @Html.DisplayNameFor(Function(model) model.MetAsEgg)
        </dt>
        <dd>
            @Html.DisplayFor(Function(model) model.MetAsEgg)
        </dd>

        @* Egg Date *@
        @If Model.MetAsEgg Then
            @<dt>
                @Html.DisplayNameFor(Function(model) model.EggMetDate)
            </dt>
            @<dd>
                @Html.DisplayFor(Function(model) model.EggMetDate)
            </dd>
        End If
...
<div>
    ...
    <table class="stat-table">
        <tr>
            <td>@Html.DisplayFor(Function(model) model.RelearnMove1)</td>
        </tr>
        <tr>
            <td>@Html.DisplayFor(Function(model) model.RelearnMove2)</td>
        </tr>
        <tr>
            <td>@Html.DisplayFor(Function(model) model.RelearnMove3)</td>
        </tr>
        <tr>
            <td>@Html.DisplayFor(Function(model) model.RelearnMove4)</td>
        </tr>
    </table>
</div>
<div>
    ...
    <dl class="dl-horizontal">
        ...
        <dd>
            <span class="@Model.LabelOTClass">@Html.DisplayFor(Function(model) model.OT)</span></dd>

        @* Handler *@
        <dt>
            @Html.DisplayNameFor(Function(model) model.LatestHandler)
        </dt>
        <dd>
            <span class="@Model.LatestHandlerClass">@Html.DisplayFor(Function(model) model.LatestHandler)</span>
        </dd>
    </dl>
</div>
<div>
